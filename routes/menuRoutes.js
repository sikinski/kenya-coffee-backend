...
export default async function (fastify) {
    // ========== TYPES (Типы позиций) ==========
    fastify.get('/menu/types', { preHandler: [fastify.authenticate] }, getMenuItemTypes)
    ...
    // ========== TAGS (Теги) ==========
    fastify.get('/menu/tags', { preHandler: [fastify.authenticate] }, getMenuTags)
    ...
    // ========== ITEMS (Позиции меню) ==========
    fastify.get('/menu/items', getMenuItems) // Публичный доступ для клиентов
    ...
    fastify.get('/menu', getMenu) // Публичный доступ
