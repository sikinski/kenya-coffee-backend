...
| Метод | Эндпоинт | Описание | Поля запроса | Авторизация |
|-------|----------|----------|--------------|-------------|
| GET | `/menu/types` | Получить все типы позиций | - | Да |
...
| Метод | Эндпоинт | Описание | Поля запроса | Авторизация |
|-------|----------|----------|--------------|-------------|
| GET | `/menu/tags` | Получить все теги | - | Да |
...
| Метод | Эндпоинт | Описание | Поля запроса | Авторизация |
|-------|----------|----------|--------------|-------------|
| GET | `/menu/items` | Получить все позиции меню | - | Нет (публичный) |
...
| Метод | Эндпоинт | Описание | Поля запроса | Авторизация |
|-------|----------|----------|--------------|-------------|
| GET | `/menu` | Получить актуальное меню | - | Нет (публичный) |
...
| Метод | Эндпоинт | Описание | Поля запроса | Авторизация |
|-------|----------|----------|--------------|-------------|
| GET | `/contacts` | Получить контакты (один объект) | - | Да |
